...
Since both of our variables are categorical, we will use our bar plot with a ch-square test and a fisher exact test. We can't use a T.test or an AOV because it's Cat & Cat 
